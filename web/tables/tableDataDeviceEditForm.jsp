        ...
        <c:forEach var="device" items="${devices}">
            <tr class="edit" data-bindID="${device.id}"> 
                <form action="editDataDeviceForm.jsp" method="get">
                  ...
                  <td>${device.name}
                      <div class="form-group">
                          <input class="form-control" name="name" type="text" value='${device.name}' required maxlength="59" />
                      </div>
                  </td>
                  <td>${device.building}
                      <div class="form-group">
                          <input class="form-control" name="building" type="text" value='${device.building}' required maxlength="49" />
                      </div>
                  </td>
                  <td>${device.note}
                      <div class="form-group">
                          <input class="form-control" name="note" type="text" value='${device.note}' required maxlength="149" />
                      </div>
                  </td>
                  <td>

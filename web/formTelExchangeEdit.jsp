...
<html>
    ...
    <body id="body-pozadi">
      ...
      <div class="d-block fixed-top my-5 pt-4 rounded-right">
        <h1>Editace TELEFONNÍ STŘEDNY</h1>
      </div>
      <div class="container my-5 pt-5">
          <h2>Editace telefonní úsředny</h2>
          ...
          <div class="container">
            <form action="editTelExchangeForm.jsp" method="get">
                ...
                <div class="d-flex justify-content-between mt-3" >
                  ...
                  <a href="readTelExchanges.jsp" type="button" class="btn btn-info col-4 col-sm-3 p-2">Telefonní ústředny</a>
                </div> 
            </form>
          </div>
      </div>

...
<table id="tabulka" class="table table-striped table-bordered" cellspacing="0" width="100%" >
    <thead>
      ...
      <tr>
        ...
        <th>Budova</th>
        <th>Poznámka</th>
        <th>Telfonní ústředna</th>
        <th>Počet</th>
        <th>Uprav</th>
      </tr>
    </thead>
    <tbody>
        <c:set var="device" value="<%= request.getSession().getAttribute("newTelExchange")%>" />
            ...
            <form action="editTelExchangeForm.jsp" method="get">
              <td>
                  ...
                  <input name="telExchangeOne" value="${device.id}" type="hidden" />
              </td>
            ...
            <form action="formTelExchangeOutputs.jsp" method="post">
                <td>
                    <input name="id" value='${device.id}' type="hidden" />
                    <div>
                        ${device.outputcount}

...
<html>
    ...
    <!-- Navbar END--> 
    <h1>TELEFONNÍ ÚSTŘEDNY - Vymazání</h1>
    <!-- Vymazní Telefonní ústředny START -->
    <div class="container">
        <h2>Vymazání telefonní ústředny</h2>
        <form action="deleteTelExchange.jsp" method="get">
            <select name="telExchangeDelId" id="telExchangeDelId" class="form-control" required>
    ...
    <!-- Vymazní Telefonní ústředny END -->         

...
<html>
  ...
  <body id="body-pozadi">
    ...
    <div class="container mt-5 py-5">
      <form action="newPBXWithOutputs.jsp" method="get">
          ...
          <div class="form-group">
            ...
            <input class="item1 form-control" name="outputCount" id="outputCount" type="number" placeholder="zadej MAXIMÁLNÍ osazení ústředny" required maxlength="9" min="0" max="999999999" />
          </div>
            <div class="d-flex justify-content-between mt-5" >
              ...
              <button class="btn btn-info col-4 col-sm-3 p-2" type="button" onclick="goToPage(this)" data-page="readPBXs.jsp">Zpět</button>
            </div> 
      </form>
    </div>
    <!-- vytvoření PBX END -->
